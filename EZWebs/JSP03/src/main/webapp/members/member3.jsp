...
<jsp:setProperty name="member" property="mid" value='<%=request.getParameter("mname") %>'/>
<jsp:setProperty name="member" property="mid" value='<%=request.getParameter("pwd") %>'/>
<jsp:setProperty name="member" property="mid" value='<%=request.getParameter("email") %>'/>
